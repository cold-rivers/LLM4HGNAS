...
def main(args):
    ...
    model_list = [{'layer_0': {('author', 'aa', 'author'): 'gat_conv', ('author', 'ap', 'paper'): 'zero_conv', 
                               ('conference', 'cp', 'paper'): 'gcn_conv', ('paper', 'pa', 'author'): 'edge_conv', 
                               ('paper', 'pp', 'paper'): 'gat_conv', ('term', 'tp', 'paper'): 'zero_conv', 'multi_aggr': 'max'},
                    'layer_1': {('author', 'aa', 'author'): 'edge_conv', ('paper', 'pa', 'author'): 'gat_conv', 'multi_aggr': 'sum'}, 
                   'inter_modes': {('0 1', 'author', 'aa', 'author'): 'gcn_conv', ('0 1', 'paper', 'pa', 'author'): 'gcn_conv'}}]
    top_code = [[2, 0, 1, 3, 2, 0, 1, 3, 2, 0, 1, 1]]
