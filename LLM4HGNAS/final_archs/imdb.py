...
best_config = {}
#default configs used in architecture search
best_config["lr"] = 0.01
...
def main(args):
    ...
    model_list = []
    top_code = [[2, 1, 3, 0, 1, 0, 1, 2, 4, 1, 2, 2, 2, 3, 4]]
    ...
    model_list = [{'layer_0': {('actor', 'aa', 'actor'): 'gat_conv', ('actor', 'am', 'movie'): 'gcn_conv', ('director', 'dd', 'director'): 'edge_conv', 
                               ('director', 'dm', 'movie'): 'zero_conv', ('movie', 'ma', 'actor'): 'gcn_conv', ('movie', 'md', 'director'): 'zero_conv',
                                 ('movie', 'mm', 'movie'): 'gcn_conv', 'multi_aggr': 'mean'},
                    'layer_1': {('actor', 'am', 'movie'): 'sage_pool', ('director', 'dm', 'movie'): 'gcn_conv', 
                                ('movie', 'mm', 'movie'): 'gat_conv', 'multi_aggr': 'mean'}, 
                   'inter_modes': {('0 1', 'actor', 'am', 'movie'): 'gat_conv', ('0 1', 'director', 'dm', 'movie'): 'edge_conv', 
                                   ('0 1', 'movie', 'mm', 'movie'): 'sage_pool'}}]
